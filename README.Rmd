...
The example above creates 2 folders (WorldClim_data and WorldClim_data_unzipped) and downloads data of **Elevation** variable for **Current** period with a **10'** resolution.
